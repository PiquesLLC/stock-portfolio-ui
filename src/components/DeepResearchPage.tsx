    ...
    return (
      <div className="max-w-3xl mx-auto">
        <button
          ...
          className="flex items-center gap-1.5 text-sm text-rh-light-text dark:text-white/80 hover:text-rh-light-text dark:hover:text-white transition-colors mb-4"
        >
