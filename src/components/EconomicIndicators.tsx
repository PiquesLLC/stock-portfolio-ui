    ...
    <button
      ...
      className={`w-full text-left border rounded-lg p-4 transition-all cursor-pointer
        ${isSelected
          ...
          : 'border-rh-light-border dark:border-rh-border hover:border-rh-light-muted dark:hover:border-rh-muted'
        }`}
      style={{
          ...
          <div className="flex items-center gap-1.5">
            ...
            {tooltip && (
              <span className="group relative flex-shrink-0">
                ...
                <span className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 rounded-lg bg-rh-light-card dark:bg-rh-dark border border-rh-light-border dark:border-rh-border px-3 py-2.5 text-[11px] leading-relaxed text-rh-light-text dark:text-rh-text shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-50">
                  {tooltip}
                </span>
              </span>
            )}
...
export function EconomicIndicators() {
  ...
  if (error || !data || usIndicatorList.length === 0) {
    return (
      <div className="bg-rh-light-card dark:bg-rh-card border border-rh-light-border dark:border-rh-border rounded-lg p-8 text-center">
  ...
  return (
    <div className="space-y-6">
      ...
      {euIndicatorList.length > 0 && (
        <div className="border-t border-rh-light-border/30 dark:border-rh-border/30" />
      )}
      ...
      {/* ── Last Sync Footer ── */}
      <div className="border-t border-rh-light-border/20 dark:border-rh-border/20 pt-4 mt-2">
...
function ChartPanel({ indicator, regionLabel, onClose }: { indicator: EconomicIndicator; regionLabel: string; onClose: () => void }) {
  return (
    <div className="bg-rh-light-card dark:bg-rh-card border border-rh-light-border dark:border-rh-border rounded-lg p-5">
