    ...
    return (
      <div className="space-y-4">
        <div className="bg-gray-50/80 dark:bg-white/[0.04] backdrop-blur-sm rounded-xl p-6 animate-pulse">
          ...
          <div className="h-16 bg-gray-100/60 dark:bg-white/[0.06] rounded mb-4" />
          <div className="space-y-3">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="h-24 bg-gray-100/60 dark:bg-white/[0.06] rounded" />
            ))}
          </div>
        </div>
      </div>
    ...
    <div className="space-y-4">
      ...
      {data.insights.map((insight, i) => {
        ...
        return (
          <div
            key={i}
            className={`bg-gray-50/80 dark:bg-white/[0.04] backdrop-blur-sm rounded-xl p-5 ${style.border}`}
          >
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-medium uppercase px-2 py-0.5 rounded-full bg-gray-50/40 dark:bg-white/[0.02] text-rh-light-muted dark:text-rh-muted">
