      ...
      {keyInsights.length > 0 && (
        <div className="mt-3 pt-3 border-t border-gray-200/30 dark:border-white/[0.04]">
          <button
            ...
            className="flex items-center gap-1.5 text-[11px] font-medium text-rh-light-text dark:text-white/80 hover:text-rh-light-text dark:hover:text-white transition-colors mb-2"
          >
