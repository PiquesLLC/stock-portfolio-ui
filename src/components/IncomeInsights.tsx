...
function IncomeConcentration({ data }: { data: IncomeInsightsResponse['concentration'] }) {
  ...
  return (
    <div className={`bg-rh-light-card dark:bg-rh-card border rounded-lg p-5 ${
  ...
  if (loading && !data) {
    return (
      <div className="space-y-6">
        <div className="animate-pulse bg-rh-light-card dark:bg-rh-card border border-rh-light-border dark:border-rh-border rounded-lg h-48" />
        <div className="animate-pulse bg-rh-light-card dark:bg-rh-card border border-rh-light-border dark:border-rh-border rounded-lg h-24" />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[1, 2, 3].map(i => (
            <div key={i} className="animate-pulse bg-rh-light-card dark:bg-rh-card border border-rh-light-border dark:border-rh-border rounded-lg h-24" />
          ))}
        </div>
      </div>
    );
