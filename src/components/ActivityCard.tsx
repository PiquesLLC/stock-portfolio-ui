          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 relative">
              ...
              {onMute && (
                ...
                >
                  <svg className="w-3.5 h-3.5 text-rh-light-text dark:text-white/80 hover:text-rh-light-text dark:hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {onReport && currentUserId !== firstEvent.userId && (
                <button
                  ...
                  className="opacity-0 group-hover/card:opacity-100 transition-opacity p-0.5 rounded hover:bg-white/[0.06]"
                >
                  <svg className="w-3.5 h-3.5 text-rh-light-text dark:text-white/80 hover:text-rh-light-text dark:hover:text-white" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
