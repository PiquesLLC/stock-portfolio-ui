...
export function AccountSettingsModal({ userId, isOpen, onClose, onSave, healthStatus, onCreatorNavigate }: AccountSettingsModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4" role="dialog" aria-modal="true">
      ...
      {/* Modal */}
      <div ref={trapRef} className="relative w-full max-w-lg mx-2 sm:mx-4 bg-white/90 dark:bg-white/[0.06] backdrop-blur-2xl border border-white/20 dark:border-white/[0.1] rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.5)] overflow-hidden max-h-[90vh]">
        {/* Header */}
