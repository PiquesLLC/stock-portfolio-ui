    ...
    <div className="min-h-screen min-h-dvh bg-black text-white">
      ...
      <div className="max-w-3xl mx-auto px-5 sm:px-8 py-10 sm:py-16">
        <div className="mb-10">
          ...
          <p className="text-sm sm:text-base text-white/80 max-w-2xl leading-7">
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-5 mb-10">
          <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/80 mb-2">Email</div>
        ...
        <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 mb-8">
          ...
          <ul className="space-y-3 text-sm text-white leading-6 list-disc pl-5">
