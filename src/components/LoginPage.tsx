  ...
  return (
    <div className="min-h-screen min-h-dvh flex items-center justify-center bg-rh-black px-4 py-8">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-rh-card rounded-2xl p-6 shadow-2xl border border-rh-border/40">
            ...
            <div className="space-y-5">
              ...
              {mode === 'verify-email' ? (<>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-white">Check your spam folder</span>
                </div>
                ...
                <div>
                  <label htmlFor="usernameEmail" className="block text-sm font-medium text-white mb-2">
                    Email
                  </label>
                  <input
                    id="usernameEmail"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-white hover:text-white transition-colors rounded"
                      tabIndex={-1}
                    >
                ...
                <div>
                  <label htmlFor="newPasswordConfirm" className="block text-sm font-medium text-white mb-2">
                ...
                {mode === 'login' && (
                  <div className="mt-2 text-right">
                    <button
                      ...
                      className="text-xs text-white hover:text-rh-green transition-colors"
                    >
                      Forgot username?
                    </button>
                  </div>
              ...
              {mode === 'signup' && (
                <label className="flex items-start gap-2.5 cursor-pointer select-none group">
                  ...
                  />
                  <span className="text-sm text-white group-hover:text-white transition-colors leading-tight">
                    I agree to the{' '}
                    <button
                      type="button"
          ...
          {(mode === 'login' || mode === 'signup') && OAUTH_ENABLED && (
            <div className="mt-5 pt-4 border-t border-rh-border/30">
              <p className="text-center text-xs text-white mb-3">Or continue with</p>
              <div className="flex gap-2">
                {GOOGLE_ENABLED && (
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-2.5 px-3 bg-rh-dark border border-rh-border/60 rounded-lg hover:border-rh-green/40 hover:bg-rh-green/5 disabled:opacity-40 transition-all text-xs font-medium text-white min-h-[44px]"
                  >
          ...
          {(mode === 'set-password' || mode === 'signup') && (
            <button
              ...
              className="w-full mt-5 text-sm text-white hover:text-white transition-colors"
            >
              ← Back to Sign In
            </button>
          )}
        ...
        {/* Footer - Trust Signal */}
        <div className="flex items-center justify-center gap-1.5 mt-6 text-xs text-white">
          <LockIcon />
