    ...
    <div className="h-screen h-dvh bg-[#050505] text-white overflow-hidden flex flex-col" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
      ...
      <div className="flex-1 overflow-y-auto relative z-10">
        ...
        <div className="max-w-lg mx-auto px-4 pt-4 pb-8">
          <div className="rounded-2xl border border-white/[0.06] bg-white/[0.02] backdrop-blur-sm px-6 py-7 text-center">

            {/* Value props */}
            <div className="flex items-center justify-center gap-5 sm:gap-8 mb-5">
              {[
                { icon: '👥', label: 'Follow investors' },
                { icon: '📊', label: 'Track your portfolio' },
            ...
            <div className="w-12 mx-auto border-t border-white/[0.06] mb-5" />

            {/* CTA copy */}
            <p className="text-[15px] text-white/60 mb-4 leading-relaxed max-w-sm mx-auto">
              Join Nala to follow real investors, track your portfolio, and get AI-powered insights.
            </p>

            <button
              onClick={() => setShowAuth(true)}
              className="px-8 py-3 bg-rh-green text-black text-sm font-bold rounded-full hover:bg-rh-green/90 transition-all shadow-[0_0_24px_rgba(0,200,5,0.2)]"
            >
